...
public class Crc8 {
	...
	public static void main(String[] args) {
		String sn = "BCD280-X1-1626-1111-6DA1F95";
//		byte crc = Crc8.calcCrc8("BCD280X116264444ED5822".getBytes());
//		int i = crc & 0xff;
//		int m = i % 16;
//
//		System.out.println("" + Integer.toHexString(m));
		...
		sn = sn.replaceAll("-", "");
		String snNoCode = sn.substring(0, sn.length() - 1);
		String code = sn.substring(sn.length() - 1);
		System.out.println(code.equals(Integer.toHexString((Crc8.calcCrc8(snNoCode.getBytes()) & 0xff)%16)));
	}
}